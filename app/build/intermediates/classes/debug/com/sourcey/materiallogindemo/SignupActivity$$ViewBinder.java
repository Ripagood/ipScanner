...
public class SignupActivity$$ViewBinder<T extends com.sourcey.materiallogindemo.SignupActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131492972, "field '_nameText'");
    target._nameText = finder.castView(view, 2131492972, "field '_nameText'");
    ...
    view = finder.findRequiredView(source, 2131492973, "field '_signupButton'");
    target._signupButton = finder.castView(view, 2131492973, "field '_signupButton'");
    view = finder.findRequiredView(source, 2131492974, "field '_loginLink'");
    target._loginLink = finder.castView(view, 2131492974, "field '_loginLink'");
  }
