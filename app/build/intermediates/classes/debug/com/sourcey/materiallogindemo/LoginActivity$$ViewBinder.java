...
public class LoginActivity$$ViewBinder<T extends com.sourcey.materiallogindemo.LoginActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131492971, "field '_loginButton'");
    target._loginButton = finder.castView(view, 2131492971, "field '_loginButton'");
    view = finder.findRequiredView(source, 2131492972, "field '_signupLink'");
    target._signupLink = finder.castView(view, 2131492972, "field '_signupLink'");
  }
